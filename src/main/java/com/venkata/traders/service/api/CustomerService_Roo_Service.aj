...
privileged aspect CustomerService_Roo_Service {
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.addToCustomerProducts(Customer customer, Iterable<Long> customerProductsToAdd);
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.removeFromCustomerProducts(Customer customer, Iterable<Long> customerProductsToRemove);
     ...
     * @return Customer
     */
    public abstract Customer CustomerService.setCustomerProducts(Customer customer, Iterable<Long> customerProducts);
