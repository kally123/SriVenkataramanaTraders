...
privileged aspect ProductsItemThymeleafController_Roo_Thymeleaf {
    ...
    public ModelAndView ProductsItemThymeleafController.update(@Valid @ModelAttribute Product product, @RequestParam("version") Integer version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
